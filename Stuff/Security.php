...
$query = "SELECT `SESSIONS`.`ID`, `SESSIONS`.`TIMEIN` , `SESSIONS`.`USER` , `SESSIONS`.`TIMEOUT` , `SITEINFO`.`URL` FROM `SESSIONS` , `SITEINFO` WHERE `SESSIONS`.`SITE` = `SITEINFO`.`SITEID` AND `SESSIONS`.`USER` = '$userid'";
/*
