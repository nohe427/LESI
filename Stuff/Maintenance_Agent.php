...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Agent Maintenance</font></td>
...
<form name="myform" form method="POST" action="Maintenance_Agent.php">
	<p align="left">Agent_ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="Agent_ID" size="20"></p>
	<p align="left">Agent_Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
	<input type="text" name="Agent_Address" size="20"></p>
	<p align="left">Agent Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="Agent_Name" size="20"></p>
	<p align="left">Agent Social:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="Agent_Social" size="20"></p>
	<p align="left">Agent Location Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="Agent_Location" size="20"></p>
	<p align="left">Agent User Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="Agent_UserID" size="20"></p>
...
function go_there()
{
 ...
 if (where_to== true)
 {
 	var NUM = document.myform.Agent_ID.value
   document.myform.jquery.value = $query = "DELETE FROM AGENT WHERE AGENT_ID='"+NUM+"'";
 ...
 else
 {
  ...
  jquery = "Select * FROM AGENT WHERE AGENT_ID = '"+NUM+"'";
  }
}
...
$A_Name = $_POST['Agent_Name'];
$A_Social = $_POST['Agent_Social'];
$A_Location = $_POST['Agent_Location'];
$A_U = $_POST['Agent_UserID'];
...
{
//Retrieve
$query = "SELECT * FROM `AGENT` WHERE AGENT_ID = '$A_ID'";
$tableQuery = "SELECT * FROM `AGENT` WHERE AGENT_ID = '$A_ID'";
}
//Modify 
elseif(isset($_POST['B4'])) 
{
if($A_ID == "" || $A_Address =="" || $A_Name =="" || $A_Social =="" || $A_Location =="" || $A_U =="")
{
...
$query = "UPDATE `AGENT` SET `AGENT_ID`='$A_ID',`AGENT_ADDRESS`='$A_Address',`NAME`='$A_Name',`AGENT_Social`='$A_Social',`LOCATION_NUM`='$A_Location',`USERID`='$A_U' WHERE `AGENT_ID`='$A_ID'";
$tableQuery = "SELECT * FROM `AGENT` WHERE AGENT_ID = '$A_ID'";
print '<script type="text/javascript">'; 
print 'alert("You have modified row '. $_POST['A_ID'].'!")'; 
print '</script>'; 
}
}
//Insert
...
{
$query = "INSERT INTO AGENT VALUES ('$A_ID','$A_Address','$A_Name','$A_Social','$A_Location','$A_U')";
$tableQuery = "SELECT * FROM `AGENT` WHERE AGENT_ID = '$A_ID'";
print '<script type="text/javascript">'; 
...
$queryLock = "LOCK TABLES AGENT WRITE;";
$queryUnlock = "UNLOCK TABLES;";
$querySelect = "Select * FROM AGENT WHERE AGENT_ID = '$A_ID'";
...
createDynamicHTMLTable("AGENT", "SELECT * FROM `AGENT` WHERE AGENT_ID = '$A_ID'", $connection);
