...
<title>Policy Maintenance</title>
...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Policy Maintenance</font></td>
...
<form name="myform" form method="POST" action="Maintenance_Policy.php">
	<p align="left">Policy ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="P1" size="20"></p>
	<p align="left">Type of Insurance ID:&nbsp;&nbsp;&nbsp;
	<input type="text" name="P2" size="20"></p>
	<p align="left">Deductible:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="P3" size="20"></p>
	<p align="left">Customer Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="P4" size="20"></p>
	<p align="left">Customer Date of Birth:&nbsp;<input type="text" name="P5" size="20"></p>
	<p align="left">&nbsp;</p>
...
function go_there()
{
 ...
 if (where_to== true)
 {
 	var NUM = document.myform.P1.value
   document.myform.jquery.value = $query = "DELETE FROM POLICY WHERE POLICY_ID='"+NUM+"'";
 ...
 else
 {
  ...
  jquery = "Select * FROM POLICY WHERE POLICY_ID = '"+NUM+"'";
  }
}
...
{
//Retrieve
$query = "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
$tableQuery = "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
}
//Modify 
elseif(isset($_POST['B4'])) {
if($P_ID == "" || $P_TYPE =="" || $P_DEDUCT =="" || $C_NUM=="" || $C_DOB =="" )
{
...
Else
{
$query = "UPDATE `POLICY` SET `POLICY_ID`='$P_ID',`TYPEOFINSURID`='$P_TYPE',`DEDUCTABLE`='$P_DEDUCT',`CUST_NUM`='$C_NUM',`CUST_DOB`='$C_DOB' WHERE `POLICY_ID`='$P_ID'";
$tableQuery = "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
print '<script type="text/javascript">'; 
print 'alert("You have modified row '. $_POST['P_ID'].'!")'; 
print '</script>'; 
}
}
//Insert
...
Else
{
$query = "INSERT INTO POLICY VALUES ('$P_ID','$P_TYPE','$P_DEDUCT','$C_NUM','$C_DOB')";
$tableQuery = "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
print '<script type="text/javascript">'; 
...
$tableQuery = "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
//print '<script type="text/javascript">'; 
//print 'alert("You have deleted row '. $_POST['P_ID'].'!")'; 
//print '</script>'; 
}
else {
	"SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'";
}
...
$queryLock = "LOCK TABLES POLICY WRITE;";
$queryUnlock = "UNLOCK TABLES;";
$querySelect = "Select * FROM POLICY WHERE POLICY_ID = '$P_ID'";
...
createDynamicHTMLTable("POLICY", "SELECT * FROM `POLICY` WHERE POLICY_ID = '$P_ID'", $connection);
