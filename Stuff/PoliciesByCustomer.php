...
<title>Policies by Customer</title>
...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Policies by Customer</font></td>
...
<form method="POST" action="PoliciesByCustomer.php">
	<p>&nbsp;&nbsp;&nbsp; CUSTOMER NUMEBR<input type="text" name="userid" size="20"></p>
	<p>&nbsp;</p>
	<blockquote>
		<blockquote>
			<blockquote>
...
$query = "SELECT * FROM POLICY WHERE `CUST_NUM` = '$userid'";
/*
