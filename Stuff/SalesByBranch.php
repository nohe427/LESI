...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Sales By Branch</font></td>
...
<form method="POST" action="SalesByBranch.php">
	<p>&nbsp;&nbsp;&nbsp; Location Number<input type="text" name="userid" size="20"></p>
	<p>&nbsp;</p>
	<blockquote>
		<blockquote>
			<blockquote>
...
$query = "SELECT AGENT.LOCATION_NUM, BILLPAY.AMT, BILLPAY.CUST_NUM FROM LOCATION, CUSTOMER, BILLPAY, AGENT WHERE AGENT.LOCATION_NUM = '$userid' AND CUSTOMER.AGENT_ID = AGENT.AGENT_ID AND CUSTOMER.CUST_NUM = BILLPAY.CUST_NUM";
//echo $query;
/*
 ...
 * number of columns.
 */
createDynamicHTMLTable("CUSTOMER", $query, $connection);
