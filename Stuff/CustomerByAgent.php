...
<title>Customers By Agent</title>
...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Customers By Agent</font></td>
...
<form method="POST" action="CustomerByAgent.php">
	<p>&nbsp;&nbsp;&nbsp; AGENT ID<input type="text" name="userid" size="20"></p>
	<p>&nbsp;</p>
	<blockquote>
		<blockquote>
			<blockquote>
...
$query = "SELECT * FROM CUSTOMER WHERE `AGENT_ID` = '$userid'";
/*
