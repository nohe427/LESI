...
<form name="myform" form method="POST" action="Maintenance_Users.php">
	<p align="left">USER ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="C1" size="20"></p>
...
function go_there()
{
 ...
 if (where_to== true)
 {
   ...
   document.myform.jquery.value = $query = "DELETE FROM USERS WHERE USERID='"+NUM+"'";
 ...
 else
 {
  ...
  jquery = "Select * FROM USERS WHERE USERID = '"+NUM+"'";
  }
}
...
$tableQuery = "SELECT * FROM `USERS` WHERE USERID = '$USER'";
}
//Modify 
...
Else
{
$query = "UPDATE `USERS` SET `USERID`='$USER',`PASSWORD`='$PASS',`AL`='$AL' WHERE `USERID`='$USER'";
$tableQuery = "SELECT * FROM `USERS` WHERE USERID = '$USER'";
print '<script type="text/javascript">'; 
print 'alert("You have modified row '. $_POST['USERID'].'!")'; 
print '</script>'; 
}
}
//Insert
...
Else
{
$query = "INSERT INTO USERS VALUES ('$USER','$PASS','$AL')";
$tableQuery = "SELECT * FROM `USERS` WHERE USERID = '$USER'";
print '<script type="text/javascript">'; 
...
$queryLock = "LOCK TABLES USERS WRITE;";
$queryUnlock = "UNLOCK TABLES;";
$querySelect = "SELECT * FROM `USERS` WHERE USERID = '$USER'";
...
createDynamicHTMLTable("CUSTOMER", "SELECT * FROM `USERS` WHERE USERID = '$USER'", $connection);
