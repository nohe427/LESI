...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Sales By Policy</font></td>
...
<form method="POST" action="SalesByPolicy.php">
	<p>&nbsp;&nbsp;&nbsp; Policy Type ID:<input type="text" name="userid" size="20"></p>
	<p>&nbsp;</p>
	<blockquote>
		<blockquote>
			<blockquote>
...
$query = "SELECT POLICY.TYPEOFINSURID, POLICY.POLICY_ID, BILLPAY.AMT FROM POLICY, BILLPAY WHERE POLICY.TYPEOFINSURID = '$userid' AND POLICY.POLICY_ID = BILLPAY.POLICY_ID";
//echo $query;
/*
