...
echo'<ul>';
echo	'<li><font size="5">';
echo	'<a href="http://acadweb1.salisbury.edu/~apnohe/LESI/Home.html">Click to ';
echo	'go to the Home Page </a></font></li>';
echo'</ul>';
echo'<p>&nbsp;</p>';
echo'<ul>';
echo	'<li><font size="5">';
echo	'<a href="http://acadweb1.salisbury.edu/~apnohe/LESI/Register.php">or click to register.</a></font></li>';
echo'</ul>';
