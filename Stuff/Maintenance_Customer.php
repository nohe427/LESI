...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Customer Maintenance</font></td>
...
<form name="myform" form method="POST" action="Maintenance_Customer.php">
	<p align="left">Customer Number :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="C1" size="20"></p>
	<p align="left">Customer Last Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C2" size="20"></p>
	<p align="left">Customer First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C3" size="20"></p>
	<p align="left">Customer Social:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C4" size="20"></p>
	<p align="left">Customer Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C5" size="20"></p>
	<p align="left">Location Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C6" size="20"></p>
	<p align="left">Agent ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C7" size="20"></p>
	<p align="left">Customer Phone Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C8" size="20"></p>
	<p align="left">Customer Date Of Birth:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C9" size="20"></p>
	<p align="left">Customer USER ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="C10" size="20"></p>
...
function go_there()
{
 ...
 if (where_to== true)
 {
 	var NUM = document.myform.C1.value
   document.myform.jquery.value = $query = "DELETE FROM CUSTOMER WHERE CUST_NUM='"+NUM+"'";
 ...
 else
 {
  ...
  jquery = "Select * FROM CUSTOMER WHERE CUST_NUM = '"+NUM+"'";
  }
}
...
{
//Retrieve
$query = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
$tableQuery = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
}
//Modify 
elseif(isset($_POST['B4'])) {
if($C_NUM == "" || $C_LAST =="" || $C_FIRST =="" || $C_SOCIAL=="" || $C_ADDRESS =="" || $LOCATION_NUM =="" || $POLICY_ID =="" || $C_PHONE =="" || $C_DOB =="" || $USERID =="")
{
...
Else
{
$query = "UPDATE `CUSTOMER` SET `CUST_NUM`='$C_NUM',`CUST_LASTNAME`='$C_LAST',`CUST_FIRSTNAME`='$C_FIRST',`CUST_SOCIAL`='$C_SOCIAL',`CUST_ADDRESS`='$C_ADDRESS',`LOCATION_NUM`='$LOCATION_NUM',`AGENT_ID`='$POLICY_ID',`CUST_PHONE`='$C_PHONE',`CUST_DOB`='$C_DOB',`USERID`='$USERID' WHERE `CUST_NUM`='$C_NUM'";
$tableQuery = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
print '<script type="text/javascript">'; 
print 'alert("You have modified row '. $_POST['C_NUM'].'!")'; 
print '</script>'; 
}
}
//Insert
...
Else
{
$query = "INSERT INTO CUSTOMER VALUES ('$C_NUM','$C_LAST','$C_FIRST','$C_SOCIAL','$C_ADDRESS','$LOCATION_NUM','$C_PHONE','$C_DOB','$USERID','$POLICY_ID')";
$tableQuery = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
print '<script type="text/javascript">'; 
...
$tableQuery = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
//print '<script type="text/javascript">'; 
//print 'alert("You have deleted row '. $_POST['C_NUM'].'!")'; 
//print '</script>'; 
}
else {
	"SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
}
...
$queryLock = "LOCK TABLES CUSTOMER WRITE;";
$queryUnlock = "UNLOCK TABLES;";
$querySelect = "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'";
...
createDynamicHTMLTable("CUSTOMER", "SELECT * FROM `CUSTOMER` WHERE CUST_NUM = '$C_NUM'", $connection);
