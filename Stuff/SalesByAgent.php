...
<table border="1" width="983" height="120">
	<tr>
		...
		<p align="center"><font size="7">Sales By Agent</font></td>
...
<form method="POST" action="SalesByAgent.php">
	<p>&nbsp;&nbsp;&nbsp; Agent Number<input type="text" name="userid" size="20"></p>
	<p>&nbsp;</p>
	<blockquote>
		<blockquote>
			<blockquote>
...
$query = "SELECT AGENT.AGENT_ID, AGENT.NAME, BILLPAY.AMT, BILLPAY.CUST_NUM FROM CUSTOMER, BILLPAY, AGENT WHERE CUSTOMER.AGENT_ID = '$userid' AND CUSTOMER.AGENT_ID = AGENT.AGENT_ID AND CUSTOMER.CUST_NUM = BILLPAY.CUST_NUM";
/*
 ...
 * number of columns.
 */
createDynamicHTMLTable("POLICY", $query, $connection);
